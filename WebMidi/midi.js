...
function loadSound(midiVal) {
    var request = new XMLHttpRequest();
    request.open('GET', "sounds/" + midiVal + ".wav", true);
...
selectMenu.addEventListener("change", function () {
    indexOfMenu = selectMenu.selectedIndex;
    reverbName = (selectMenu.options[selectMenu.selectedIndex].value);
