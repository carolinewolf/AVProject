...
void VideoEngine::setInputWidget(VideoWidget *inputWidget){
    connect(this, &VideoEngine::sendInputImage, inputWidget, &VideoWidget::setImage);
}
void VideoEngine::setProcessedWidget(VideoWidget *processedWidget){
    connect(this, &VideoEngine::sendProcessedImage, processedWidget, &VideoWidget::setImage);
}
